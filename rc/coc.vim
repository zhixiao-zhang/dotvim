...
augroup ResetCocHighlight
  autocmd!
  autocmd User CocNvimInit hi CocFloating guibg=NONE ctermbg=NONE
  autocmd User CocNvimInit hi link CocErrorHighlight Error
  autocmd User CocNvimInit hi link CocWarningHighlight Error
  autocmd User CocNvimInit hi CocInlayHint cterm=italic guifg=#BA9AB9
augroup end
